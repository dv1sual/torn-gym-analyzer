...
export const gyms: Gym[] = [
  ...
  { name: 'Average Joes', energy: 5, dots: { str: 2.4, spd: 2.4, def: 2.7, dex: 2.4 } },
  { name: "Woody's Workout", energy: 5, dots: { str: 2.7, spd: 3.2, def: 3.0, dex: 2.7 } },
  ...
  { name: 'Complete Cardio', energy: 10, dots: { str: 5.5, spd: 5.7, def: 5.5, dex: 5.2 } },
  { name: 'Legs Bums & Tums', energy: 10, dots: { str: 0.0, spd: 5.5, def: 5.5, dex: 5.7 } },
  ...
  { name: 'Gun Shop', energy: 10, dots: { str: 6.5, spd: 6.4, def: 6.2, dex: 6.2 } },
  { name: 'Force Training', energy: 10, dots: { str: 6.4, spd: 6.5, def: 6.4, dex: 6.8 } },
  { name: "Cha Cha's", energy: 10, dots: { str: 6.4, spd: 6.4, def: 6.8, dex: 7.0 } },
  { name: 'Atlas', energy: 10, dots: { str: 7.0, spd: 6.4, def: 6.4, dex: 6.5 } },
  { name: 'Last Round', energy: 10, dots: { str: 6.8, spd: 6.5, def: 7.0, dex: 6.5 } },
